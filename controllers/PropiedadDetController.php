...
use app\models\PropiedadDetSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PropiedadDetController implements the CRUD actions for PropiedadDet model.
 */
class PropiedadDetController extends Controller
{
...
///
    ...
    /**
     * Displays a single PropiedadDet model.
     * @param string $id
     * @return mixed
     */
...
///
    ...
    /**
     * Creates a new PropiedadDet model.
...
//            return $this->redirect(['view', 'id' => $model->id_propiedad_det]);
    ...
    /**
     * Updates an existing PropiedadDet model.
...
//            return $this->redirect(['view', 'id' => $model->id_propiedad_det]);
    ...
    /**
     * Deletes an existing PropiedadDet model.
...
///
    ...
    /**
     * Finds the PropiedadDet model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return PropiedadDet the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PropiedadDet::findOne($id)) !== null) {
            return $model;
        } else {
